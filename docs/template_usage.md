...
Once token and app are added, go back to the `Actions` tab and re-run the failing workflows.
...
[codecov token]: https://docs.codecov.com/docs/adding-the-codecov-token
